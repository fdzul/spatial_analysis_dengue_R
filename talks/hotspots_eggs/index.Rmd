...
source("C:/Users/HOME/Dropbox/r_developments/r_new_functions/3.Functions/eggs_risk.R")

# Step 2. apply the function 
eggs_risk(path_vect = "31_yucatan",
          path_coord = "31_yucatan/DescargaOvitrampasMesFco.txt",
          cve_edo = "31",
          map_view = FALSE,
          weeks = 43,
          locality = "Valladolid",
...
.panelset.sideways[
```{r include=FALSE}
eggs_week_41  <- c(source = "Prediccion Sem 41 Code",
                   output = "Prediccion Sem 41")
eggs_week_42 <- c(source = "Prediccion Sem 42 Code",
                  output = "Prediccion Sem 42")
eggs_week_43 <- c(source = "Prediccion Sem 43 Code",
                  output = "Prediccion Sem 43")

```

```{r panelset = eggs_week_41, warning=FALSE, message=FALSE}
deneggs::eggs_hotspots(path_lect = "31_yucatan",
                       cve_ent = 31,
                       locality  = "Merida",
                       path_coord = "31_yucatan/DescargaOvitrampasMesFco.txt",
...
```{r panelset = eggs_week_42, warning=FALSE, message=FALSE}
deneggs::eggs_hotspots(path_lect = "31_yucatan",
                       cve_ent = 31,
                       locality  = "Merida",
                       path_coord = "31_yucatan/DescargaOvitrampasMesFco.txt",
...
```{r panelset = eggs_week_43, warning=FALSE, message=FALSE}
deneggs::eggs_hotspots(path_lect = "31_yucatan",
                       cve_ent = 31,
                       locality  = "Merida",
                       path_coord = "31_yucatan/DescargaOvitrampasMesFco.txt",
...
### Decisiones Basadas en Evidencia & Ovitrampas
<hr style="height:2px;border-width:0;color:#330019;background-color:#330019">
![](fig/hotspots_eggs_intensity_guadalajara.jpg)
