...
```
---
### Visualización de Ovitrampas y Decisiones Basadas en Evidencia
...
.panelset.sideways[
```{r include=FALSE}
ovitraps_distribution <- c(source = "Distribución de Ovitrapas Código",
                           output = "Distribución de Ovitrapas Mapa")
...
eggs_hotspots(path_vect = "C:/Users/HOME/Dropbox/cenaprece_datasets/2022/31_yucatan",
              cve_ent = "31",
              locality = "Tizimín",
              week = 43,
              brand = "slack")
