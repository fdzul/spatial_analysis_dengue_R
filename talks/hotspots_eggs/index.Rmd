...
DiagrammeR::grViz("digraph {
  ...
  #
  brote [label = 'Brote',  fillcolor = '#F4B400', color = 'white', fontcolor = 'black']
  cp [label = 'Control de Probables',  fillcolor = '#F4B400', color = 'white', fontcolor = 'black']
  
  node [shape = circle, style = filled, color = grey] 
  irs [label = 'Rociado Residual',  fillcolor = '#F4B400', color = 'white', fontcolor = 'black']
  cl [label = 'Control Larvario',  fillcolor = '#F4B400', color = 'white', fontcolor = 'black']
  ovitraps [label = 'Ovitrampas',  fillcolor = '#F4B400', color = 'white', fontcolor = 'black']
  adult [label = 'Colecta de Adultos',  fillcolor = '#F4B400', color = 'white', fontcolor = 'black']
  enc_ver [label = 'Encuesta Verificación',  fillcolor = '#F4B400', color = 'white', fontcolor = 'black']
  plat [label = 'Plataforma',  fillcolor = '#F4B400', color = 'white', fontcolor = 'black']
  
  #########
  node [shape = rectangle, style = filled, color = black, fixedsize = true, width = 2.5] 
  hotspots [label = 'Hotspots',  fillcolor = '#F4B400', color = 'white', fontcolor = 'black']
  act [label = 'Casos Actuales',  fillcolor = '#F4B400', color = 'white', fontcolor = 'black']
 
  epi [label = 'Vigilancia Epidemiológica',  fillcolor = '#DB4437', color = 'white', fontcolor = 'white']
  ent [label = 'Vigilancia Entomológica',  fillcolor = '#DB4437', color = 'white', fontcolor = 'white']
...
DiagrammeR::grViz("digraph {
  ...
  epi [label = 'Vigilancia Epidemiológica',  fillcolor =  '#FF5A5F', color = 'white', fontcolor = 'white']
