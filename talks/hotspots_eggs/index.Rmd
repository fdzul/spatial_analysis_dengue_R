...
DiagrammeR::grViz("digraph {
  ...
  ###########
  prog_den [label = 'Programa de Dengue',  fillcolor =  '#36C5F0', color = 'white', fontcolor = 'black']
  ...
  epi [label = 'Vigilancia Epidemiológica',  fillcolor = '#2EB67D', color = 'white', fontcolor = 'black']
  ent [label = 'Vigilancia Entomológica',  fillcolor = '#2EB67D', color = 'white', fontcolor = 'black']
