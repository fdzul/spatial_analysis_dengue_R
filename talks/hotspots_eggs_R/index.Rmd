...
panelset.sideways[
```{r include=FALSE}
spde_14_gua <- c(source = "código",
                 output = "Mapa Predictivo")
```

```{r panelset = spde_14_gua, out.width='100%', warning=FALSE, message=FALSE}
names(deneggs::eggs_hotspots(path_lect = "/Users/fdzul/Dropbox/cenaprece_datasets/2022/14_jalisco/",
                       cve_ent = 14,
