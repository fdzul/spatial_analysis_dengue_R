...
x$ageb |>
    dplyr::select(n) |>
    sf::st_drop_geometry() |>
    dplyr::mutate(wx = c(2, 60, 18, 38, 37, 154, 187, 0)) |>
...
---
## Distribucion de casos por AGEB
```{r echo=FALSE, warning = FALSE,message = FALSE, fig.align ="center"}
#
#load("C:/Users/HOME/Dropbox/r_developments/r_talks/test_dengue_spatial_analysis/RData/acapulco_getis.RData")
load("~/Dropbox/r_developments/r_talks/test_dengue_spatial_analysis/RData/acapulco_getis.RData")
# map ####
x$ageb |>
    dplyr::bind_cols(z) |>
    ...
    fishualize::scale_fill_fish(discrete = FALSE,  option = "Hypsypops_rubicundus") +
    cowplot::theme_map()
...
load("~/OneDrive/proyects/priority_research_projects/hotspots_high_risk_localities_138/8.RData/geocoded_dataset.RData")
...
# Step 3. count dengue cases by AGEB ####
library(magrittr)
...
# Step 5. visualizacion de la intensidad de transmisión de dengue ###
