...
```{r panelset = square_grid,out.width='100%', warning=FALSE, message=FALSE}
...
```{r panelset = hexagonal_grid, out.width='100%', warning=FALSE, message=FALSE}
# Step 2. make the grid #####
...
# Step 1. define the directory of ovitraps ####
path_ovitraps <- "C:/Users/HOME/Dropbox/cenaprece_datasets/2022/14_jalisco"
path_coord <- paste(path_ovitraps, "DescargaOvitrampasMesFco.txt", sep = "/")

# Step 2. create the mesh ####

spde_mod <- deneggs::eggs_hotspots(path_lect = path_ovitraps,
                                   cve_ent = 14,
