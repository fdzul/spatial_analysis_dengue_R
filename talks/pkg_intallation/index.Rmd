...
En mac se requiere instalar [X11](https://www.baeldung.com/linux/x11), ya sea por medio de [xcode](https://developer.apple.com/xcode/) o [XQuartz](https://www.xquartz.org/)
...
2 ir a la pagina de [Homebrew](https://brew.sh/)

3) copiar y pegar el siguiente link en la terminal
...
4) ejecutar el siguiente código en la terminal
