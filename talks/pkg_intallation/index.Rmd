...
```{r, echo=TRUE, warning=FALSE, message=FALSE, error=FALSE}
install.packages("C:/Users/felip/Downloads/ggplot2_3.3.5.tar.gz", repos = NULL, type = "source")
```

Para archivos binarios en WINOS

```{r, echo=TRUE, warning=FALSE, message=FALSE, error=FALSE}
install.packages("C:/Users/felip/Downloads/ggplot2_3.3.5.zip", repos = NULL, type = "win.binary")
```

Para archivos binarios en MACOS

```{r, echo=TRUE, warning=FALSE, message=FALSE, error=FALSE}
#install.packages("C:/Users/felip/Downloads/ggplot2_3.3.5.tgz", repos = NULL, type = "win.binary")
```
...
- ***Biografia*** : https://fdzul.github.io/web_site_fadm/
