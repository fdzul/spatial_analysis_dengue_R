...
knox_merida_conf <- c(source = "Código",
                      output = "Confirmados")
```
```{r panelset = knox_merida_prob, out.width='90%', warning=FALSE, message=FALSE}
...
```{r panelset = knox_merida_conf, out.width='90%', warning=FALSE, message=FALSE}
# Step 1. load the dengue cases geocoded
load("C:/Users/HOME/OneDrive/proyects/geocoding_mex/2022/9.RData_geocoded/geo_den_mx_31_merida_2022_10_31.RData")
...
.panelset.sideways[
```{r include=FALSE}
lgcp_merida <- c(source = "Código1",
                 output = "Mérida")
lgcp_hermosillo <- c(source = "Código2",
                     output = "Hermosillo")

lgcp_navojoa <- c(source = "Código3",
                  output = "Navojoa")
```
