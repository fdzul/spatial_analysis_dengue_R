...
knox_merida_conf <- c(source = "Código",
                      output = "Confirmados")
```
```{r panelset = knox_merida_prob, out.width='100%', warning=FALSE, message=FALSE}
...
```{r panelset = knox_merida_conf, out.width='100%', warning=FALSE, message=FALSE}
# Step 1. load the dengue cases geocoded
load("C:/Users/HOME/OneDrive/proyects/geocoding_mex/2022/9.RData_geocoded/geo_den_mx_31_merida_2022_10_31.RData")
...
```{r panelset = lgcp_merida, out.width='100%', warning=FALSE, message=FALSE}
...
```{r panelset = lgcp_hermosillo, out.width='100%', warning=FALSE, message=FALSE}
# Step 1. load the dengue geocoded dataset ####
load("C:/Users/HOME/OneDrive/proyects/geocoding_mex/2022/9.RData_geocoded/den2022_positivos.RData")
...
lgcp_hermosillo <- denhotspots::spatial_lgcp(dataset = geocoded_dataset,
                                             locality = "Hermosillo",
                                             cve_edo = "26",
                                             longitude = "x",
                                             latitude = "y",
...
```{r panelset = lgcp_navojoa, out.width='100%', warning=FALSE, message=FALSE}
